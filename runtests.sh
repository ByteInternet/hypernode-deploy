...
$HN test -f /data/web/supervisor/example.conf || ($HN ls -al /data/web/supervisor/ && exit 1)
$HN test $($HN readlink -f /data/web/supervisor) = /data/web/apps/magento2.komkommer.store/releases/1/supervisor
...
$HN test $($HN readlink -f /data/web/supervisor) = /data/web/apps/magento2.komkommer.store/releases/2/supervisor
