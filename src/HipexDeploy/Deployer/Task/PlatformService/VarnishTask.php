...
namespace HipexDeploy\Deployer\Task\PlatformService;

use HipexDeploy\Deployer\Task\ConfigValidationInterface;
...
use HipexDeployConfiguration\PlatformService\VarnishService;
