...
use function HipexDeploy\Deployer\getenvFallback;
    ...
    public function getDockerImage(Configuration $config, string $suffix): string
    {
        try {
            ...
            throw new EnvironmentVariableNotDefinedException(
                'Could not find image name, use `HipexDeployConfiguration\Configuration::setDockerImage` ' .
    ...
    public function getImageRegistry(Configuration $config): string
    {
        try {
            ...
            throw new EnvironmentVariableNotDefinedException(
                ...
                '`\HipexDeployConfiguration\Configuration::setDockerRegistry` method or `CI_REGISTRY` env variable.'
            );
        }
    }
